...
__IO uint32_t StartUpCouters = 0;
 ...
 HW_RCC_DEF void RCC_Configuration(void)
{
    ...
    do
    {
        ...
        StartUpCouters++;  
    } while((HSEStatus == 0) && (StartUpCouters != HSEStartUp_TimeOut));
...
HW_RCC_DEF void RCC_APBfunction(uint32_t RCC_AHBPeriph, FunctionalState NewState)
{
    if (NewState != DISABLE)
  {
